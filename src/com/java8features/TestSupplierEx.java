...
public class TestSupplierEx {
	...
	public static void main(String[] args) {
       ...
       System.out.println("To return current date and time");
	...
	System.out.println(s3.get());
	 ...
	 System.out.println();//rule pw = length 8 chars, 2,4,6,8 only digits , 1,3,5,7 places only uppercase,sp chars #,&,*,@
     System.out.println("To generate some random passwors: "); // A1@3b9k7
